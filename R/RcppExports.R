...
sparse_odpc_priv <- function(Z, resp, k_tot_max, k1, k2, num_comp, tol, niter_max, a_ini, D_ini, lambda_grid) {
    .Call(`_odpc_sparse_odpc_priv`, Z, resp, k_tot_max, k1, k2, num_comp, tol, niter_max, a_ini, D_ini, lambda_grid)
}
